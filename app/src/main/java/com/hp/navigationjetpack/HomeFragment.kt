...
import com.hp.navigationjetpack.databinding.FragmentHomeBinding
    ...
    override fun onCreateView(
        ...
        binding.button.setOnClickListener{
            ...
            if(!TextUtils.isEmpty(binding.editText.text.toString())) {
                ...
                //it represents the view , here its the button itself
            ...
            {
                Toast.makeText(activity,"Cant be null",Toast.LENGTH_LONG).show()
            }
